<dialog id="mymodalcenteredMobile" class="bg-transparent  relative w-screen h-screen">
    <div class="p-0 flex justify-center items-center fixed left-0 top-0 w-full h-full bg-black bg-opacity-80 transition-opacity duration-300 opacity-0">
        <div class="bg-white flex rounded-lg w-full relative">
            <div class="flex flex-col items-start w-full">
                <div class="p-3 flex items-stretch w-full">
                    <div class="font-thin text-3xl text-gray-900">{{$properties->title_en}}</div>
                    <svg onclick="modalClose('mymodalcenteredMobile')" class="ml-auto fill-current text-gray-700 w-5 h-5 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
                ...
                <form class="flex flex-col items-start w-full"  method="post" action="{{ route('luxe.form.new.projects.details') }}">
                    @csrf
                    <div class="px-3  w-full" style="max-height: 40vh;">
                    ...
                    <div class="p-3 flex justify-end items-center w-full">
                        ...
                        <button type="button" onclick="modalClose('mymodalcenteredMobile')" class="bg-transparent hover:bg-gray-500 text-gray-800 font-semibold hover:text-white py-2 px-4 border border-gray-500 hover:border-transparent rounded"   >
                            Close
                        </button>
                    </div>
                </form>
