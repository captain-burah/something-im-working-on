...
<div class="sm:container sm:mx-auto mx-0 px-0 mx-auto sm:h-[25vh] xl:h-[50vh]">
    <div class="row-span-2 grid sm:grid-cols-2 gap-4 h-[100%] w-[100%]">
        <div>
            <iframe height="250px" width="100%" src="https://www.youtube.com/embed/ef2o1-VpoSc?si=KmbSbrKHYHuw-YPz&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        <div>
