<div class="sm:container sm:mx-auto mx-0 px-0 sm:px-4 my-20 sm:my-4 mx-auto">
    ...
    <h2 class="text-esnaad_text text-justify font-light my-8 text-2xl">
        ...
        condimentum eget ac dui. Nulla non nisl mollis ipsum laoreet ultrices ac in sapien. Lorem
    </h2>
