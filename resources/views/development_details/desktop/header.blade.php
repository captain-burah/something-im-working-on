...
<header>
    <div class="w-full bg-cover bg-center" style="height: 100vh; background-image: url('{{ URL::asset('assets/img/img-error2.webp')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
