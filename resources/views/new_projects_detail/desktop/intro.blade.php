    ...
    <div class="container text-sm text-gray-500">
        ...
        <div class="flex flex-wrap grid sm:grid-cols-3 gap-2 my-2 w-full">
            <div class="col-span-2">
                ...
                /
                <a href="{{ route('luxe.new-projects') }}" aria-label="luxe-properties-dubai-new-projects" aria-label="dubai-new-projects" class="text-gray-400 font-light hover:text-gray-500 ">
                    Dubai New Projects
                </a>
                /
                ...
                /
                <a href="{{ route('luxe.new-projects') }}" aria-label="luxe-properties-dubai-new-projects" aria-label="project-type-routes" class="text-gray-400 font-light hover:text-gray-500 ">
