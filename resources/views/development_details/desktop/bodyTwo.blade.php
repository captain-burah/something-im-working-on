...
<div class="sm:container sm:mx-auto mx-0 px-0 my-20 sm:my-4 mx-auto  xl:h-[50vh]">
    <div class="row-span-2 grid xl:grid-cols-2 gap-4 h-[100%] w-[100%]">
        ...
        <div class="xl:m-10">
            <h2 class="text-esnaad_text text-justify font-base text-xl xl:text-3xl xl:w-[90%] leading-8">
