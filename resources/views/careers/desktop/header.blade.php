...
<header class="">
    <div class="w-full bg-cover bg-center  grayscale" style="height: 75vh; background-image: url('{{ URL::asset('developments/15.jpg')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
