    ...
    <div class="container text-sm text-gray-500">
        ...
        <div class="flex">
            ...
            <div class="flex-initial w-64 ...">
                <a href="{{ route('luxe.dubai-developers') }}" aria-label="luxe-properties-dubai-home" aria-label="home-route" class="text-xs text-gray-400 font-light hover:text-gray-500 ">
                    Back to All Developers Page
                </a>
            </div>
        </div>
