...
<header>
    <div class="w-full bg-cover bg-center " style="height:32rem; background-image:
        @if($isset($images) && count($images) > 1)
            url('{{URL::asset('uploads/properties/'.$properties->id.'/'.$images[1]->image)}}')
        @else
            url('{{ URL::asset('assets/img/img-error2.webp')}}')
        @endif;">
