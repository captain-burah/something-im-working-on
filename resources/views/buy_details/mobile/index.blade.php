...
@section('content')
    @mobile
        ...
        <div class="block relative isolate overflow-hidden mb-3">
                @include('buy_details.mobile.header')
        </div>

        <div class="block relative isolate overflow-hidden my-3">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 mt-3">
                @include('buy_details.mobile.intro')
            </div>
        </div>

        <section class="mb-3">
            @include('buy_details.mobile.infobar')
        </section>


        <section class="my-3">
            @include('buy_details.mobile.body')
        </section>

        <section class="my-3" id="project_detail_map_section">
            @include('buy_details.mobile.map')
        </section>

        <section class="my-3">
            @include('buy_details.mobile.similarProps')
        </section>
