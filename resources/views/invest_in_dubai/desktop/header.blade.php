...
<header class="">
    <div class="w-full bg-cover bg-center" style="height: 50vh; background-image: url('{{ URL::asset('home/invest-in-dubai.webp')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
