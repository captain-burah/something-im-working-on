            ...
            <div class="">
                <div class="row-span-2 grid h-3/5 grid-cols-3 bg-white  shadow-lg">
                    <div class="row-span-2 col-span-2 border">
                        <div class="w-full bg-cover bg-center" style="height:32rem; background-image: url('{{URL::asset('uploads/properties/'.$properties->id.'/'.$images[1]->image)}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
...
@include('buy_details.desktop.modals.galleryModal')
@include('buy_details.desktop.modals.inquiryModal')
