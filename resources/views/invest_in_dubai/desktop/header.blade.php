...
<header class="">
    <div class="w-full bg-cover bg-center" style="height: 75vh; background-image: url('{{ URL::asset('home/invest-in-dubai.webp')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
