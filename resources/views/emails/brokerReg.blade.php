    ...
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top">
        <tbody>
            ...
            <td valign="top" style="padding:0;Margin:0">
                ...
                <table class="es-header" cellspacing="0" cellpadding="0" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:#000;background-repeat:repeat;background-position:center top">
                <tbody>
                    <tr style="border-collapse:collapse">
                    <td align="center" style="padding:0;Margin:0">
                        <table class="es-header-body" cellspacing="0" cellpadding="0" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#000;width:600px">
                        <tbody>
                            <tr style="border-collapse:collapse">
                ...
                <tbody>
                    <tr style="border-collapse:collapse">
                    <td style="padding:0;Margin:0;background-color:#000" bgcolor="#000" align="center">
                                    ...
                                    <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                        ...
                                        <tbody>
                                            ...
                                            <td align="center" style="Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px">
                                                <h1 style="Margin:0;line-height:48px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:25px;font-style:normal;font-weight:normal;color:#111111">NOTIFICATION - BROKER REGISTRATION</h1>
                                            </td>
                                            </tr>
                                            <tr style="border-collapse:collapse">
                                ...
                                <tbody>
                                    ...
                                    <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666">
                                                    Exciting news! We are thrilled to inform you that a new broker has just registered through our system, and it looks like a fantastic opportunity for us to verify the broker thoroughly from the records submited and attached in this email
                                                </p>
                                            </td>
                                            </tr>                                           
                                            ...
                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666">
                                                    Once the registered broker has been verified, please enter the registration details into the ESNAAD Management Information System (MIS)
                                                </p>
                                            </td>
                                            </tr>
                                ...
                                <tbody>
                                    ...
                                    <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                <p style="text-align: right; Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666">
                                                    Company Name <br>
                                                    Company Type <br>
                                                    Trade License Number : <br>
                                                    Trade License Expiry : <br>
                                ...
                                <tbody>
                                    ...
                                    <td valign="top" align="center" style="padding:0;Margin:0;width:540px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="border-collapse:collapse">
                                            <td align="left" style="padding:0;Margin:0;padding-top:25px">
                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666">Unit G07, City Walk Building #1, Al Wasl, Dubai - United Arab Emirates</p>
                                            </td>
                                            </tr>

                                            <tr style="border-collapse:collapse">
                                            <td align="justify" style="padding:0;Margin:0;padding-top:25px">
                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#CCCCCC">
                                                "This message contains confidential information and is intended for the attention of the named recipient ONLY. 
                                                This email and any information, attachments or files transmitted with it are confidential and intended solely 
                                                for the use of the individual or entity to whom they were addressed. If you are not the recipient and have received 
                                                this email in error, you should not disseminate, distribute or copy this e-mail. Alternatively, please notify 
                                                the sender immediately by e-mail and delete from your system. Further, you are hereby notified that disclosing, 
                                                copying, distributing or taking any action in reliance on the contents of this email including entire information 
                                                included is strictly prohibited and may be unlawful."
                                                </p>
                                            </td>
                                            </tr>
                                        </tbody>
