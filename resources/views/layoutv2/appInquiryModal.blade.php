<dialog id="mymodalcenteredInquiry" class="bg-transparent  relative w-screen h-screen">
        ...
        <div class="bg-white flex rounded-lg w-1/4 relative">
            <div class="flex flex-col items-start w-full">
                <div class="p-7 flex items-stretch w-full">
                    <div class="font-thin text-3xl text-gray-900" id="heading"></div>
                    <svg onclick="modalClose('mymodalcenteredInquiry')" class="ml-auto fill-current text-gray-700 w-5 h-5 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
                        <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z" />
                    </svg>
                </div>
                <form class="flex flex-col items-start w-full"  method="post" action="">
                    @csrf
                    <div class="px-7  w-full" style="max-height: 40vh;">

                        <input type="hidden" id="app_property_id" name="property_id" >
                        <input type="hidden" id="app_country_code" name="country_code">
                        <input type="hidden" id="app_url" name="url" value="{{Request::url()}}">
                        ...
                        <div class="mb-6">
                            <input type="tel" id="phone" name="phone" class="iti-phone w-max px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500" placeholder="Phone" style="width: 100% !important" required>
                        </div>
                    </div>
                    ...
                    <div class="p-7 flex justify-end items-center w-full">
                        ...
                        <button type="button" onclick="modalClose('mymodalcenteredInquiry')" class="bg-transparent hover:bg-gray-500 text-gray-800 font-semibold hover:text-white py-2 px-4 border border-gray-500 hover:border-transparent rounded"   >
                            Close
                        </button>
                    </div>
                </form>
