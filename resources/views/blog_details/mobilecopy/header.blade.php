        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="mb-4 h-full">
                    <img
                        ...
                        src="{{ asset('uploads/developers/'.$properties->id.'/'.$properties->background_image)}}"
                        onerror="this.onerror=null;this.src='{{ URL::asset('assets/img/img-error2.webp')}}';"
                        alt="lpd-blogs-images-{{$properties->background_image}}"
                        style="width: 100% !important; heigh: 100% !important;"
                    >
