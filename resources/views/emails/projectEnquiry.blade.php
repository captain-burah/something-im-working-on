                                    ...
                                    <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                        ...
                                        <tbody>
                                            ...
                                            <td align="center" style="Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px">
                                                <h1 style="Margin:0;line-height:48px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:25px;font-style:normal;font-weight:normal;color:#111111">NOTIFICATION - PROJECT ENQUIRY</h1>
                                            </td>
                                            </tr>
                                            <tr style="border-collapse:collapse">
                                ...
                                <tbody>
                                    ...
                                    <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666">
                                                    Exciting news! We are thrilled to inform you that an enquiry just came in through our system, and it looks like a fantastic opportunity for us to verify the broker thoroughly.
                                                </p>
                                            </td>
                                            </tr>      
                                            ...
                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666">
                                                    Project Name - {{ $data['enquiry_type'] }}
                                                </p>
                                            </td>
                                            </tr>
