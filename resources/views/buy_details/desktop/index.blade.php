    ...
    @notmobile
        ...
        <div class="block relative isolate overflow-hidden my-3">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 mt-3">
                @include('buy_details.desktop.intro')
            </div>
        </div>

        <section class="my-3">
            @include('buy_details.desktop.gallery')
            {{-- @include('buy_details.desktop.header') --}}
        </section>

        <section class="mb-3">
            @include('buy_details.desktop.infobar')
        </section>


        <section class="my-3">
            @include('buy_details.desktop.body')
        </section>

        <section class="my-3" id="project_detail_map_section">
            @include('buy_details.desktop.map')
        </section>

        <section class="my-3">
            @include('buy_details.desktop.similarProps')
        </section>
