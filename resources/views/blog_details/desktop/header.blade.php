...
<header>
    ...
    <div class="w-full bg-cover bg-center" style="height:32rem; background-image: url('{{URL::asset('uploads/blogs/'.$properties->id.'/'.$properties->image_url)}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
