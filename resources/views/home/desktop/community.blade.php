{{-- Desktop View --}}
<div class="sm:container sm:mx-auto mx-0 px-0 sm:px-4 my-20 sm:my-5 mx-auto">
    <div class="row">
        <div class="grid md:grid-cols-2 gap-12 mb-5 mx-auto">
            <div>
                ...
                <p class="text-sm xl:text-base leading-8">
