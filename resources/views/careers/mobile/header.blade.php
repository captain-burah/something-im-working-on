...
<header>
    <div class="w-full bg-cover bg-center grayscale" style="margin-top: 60px; height: 40vh; background-image: url('{{ URL::asset('developments/15.jpg')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
